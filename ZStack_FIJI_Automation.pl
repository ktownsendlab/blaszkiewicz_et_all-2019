...
for ($i; $i <= $end; $i++){		# This for loop will cycle through all the images
	...
	my $command = "/Applications/Fiji.app/Contents/MacOS/ImageJ-macosx --ij2 -macro General_Arborization_Macro.ijm ";
...
# Thresholded STDEV Projection
$command .= "/Volumes/Big_Red/HET3_Whole_Depot/Threshold_STDEV/AF10_ch00/${file}_stdev.tif,";

# Skeleton
$command .= "/Volumes/Big_Red/HET3_Whole_Depot/FIJI_Skeletons/AF10_ch00/${file}_skeleton.tif,";

# Arborization Results
$command .= "/Volumes/Big_Red/HET3_Whole_Depot/Arborization_Results/AF10_ch00/${file}_branching.csv,";
